...
void Statistics::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sessionRecorded((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->gameCompleted((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Statistics::*)(int )>(_a, &Statistics::sessionRecorded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Statistics::*)(int )>(_a, &Statistics::gameCompleted, 1))
            return;
    }
}
...
// SIGNAL 0
void Statistics::sessionRecorded(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Statistics::gameCompleted(int _t1)
{
